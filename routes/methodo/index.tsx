...
const description = `Description de la méthodologie utilisée pour recueillir les données concernant les réseaux sociaux où sont présents les politiciens.`
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '50rem' }}>
        ...
        <br />
        Les données viennent de <a href="https://datan.fr">datan.fr</a> pour les
        députés français via{' '}
        <a href="https://www.data.gouv.fr/datasets/deputes-actifs-de-lassemblee-nationale-informations-et-statistiques">
          ce jeu de données data.gouv
        </a>
        et du{' '}
